...
} from "../type/cnsUserRecord"
import {
  PubKeyAddress, ScriptAddress
} from "../type/plutus"
import {
  addrBech32ToObj, stringToHex
} from "../utils"

const virtualDomains = [
  [
    "script",
    "addr_test1wpfst96dzagcy3wyz0r7xsm5acpx8w88w7sgjhr33cw347qsch0tg"
  ],
  [
    "test1",
  ...
  [
    "test3",
    "addr_test1vrgkr4jwau8wkk0ezf84yruv3uahzlksgxvd2nytzlnqfts6z879a"
  ],
  [
    "test4",
...
const makeCNSUserRecord = (virtualDomainsI: string[][], socialProfilesI: string[][], otherRecordsI: string[][]): CNSUserRecord => {
  ...
  const userRecordDatumObj: CNSUserRecord = cnsUserRecord(virtualDomainsHashes, socialProfilesHexes, otherRecordsHexes)
  return userRecordDatumObj
}


const userRecordDatumObj: CNSUserRecord = makeCNSUserRecord(virtualDomains, socialProfiles, otherRecords)
